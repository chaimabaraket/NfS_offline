...
rpm -Uvh quota-4.01-19.el7.x86_64.rpm
rpm -Uvh quota-nls-4.01-19.el7.noarch.rpm
rpm -Uvh rpcbind-0.2.0-49.el7.x86_64.rpm
rpm -Uvh tcp_wrappers-7.6-77.el7.x86_64.rpm
systemctl enable nfs-client.target
systemctl start nfs-client.target
echo "The NFS client setup is complete!"
